...
function page() {
  return (
    <div className="container">
      <h2 className="text-center font-bold m-6 text-[24px]">
      ...
      <p className="italic">
        workshops that are relevant and impactful. Your task is to generate 5
        ideas for professional development presentations on the topic of
        education technology. The presentations should be 1.5 – 3 hours each.
